...
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/comtypes-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/comtypes-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/comtypes/badges/version.svg)](https://anaconda.org/conda-forge/comtypes)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/comtypes/badges/downloads.svg)](https://anaconda.org/conda-forge/comtypes)
